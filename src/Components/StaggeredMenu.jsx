    ...
    return (
        ...
        >
            ...
            >
                ...
                <header
                    className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-20 transition-transform duration-300 ease-out"
                    aria-label="Main navigation header"
                    style={{
                        transform: isVisible ? 'translateY(0)' : 'translateY(-180%)'
                    }}
                >
                    <a
                        href="#home"
                        onClick={(e) => handleNavClick(e, '#home')}
                        className="sm-logo pointer-events-auto cursor-pointer"
                        aria-label="Logo"
                    >
                        <img
...
.sm-scope .sm-logo { display: flex; align-items: center; justify-content: center; user-select: none; border-radius: 9999px; background: #ffffff; padding: 3px; width: 42px; height: 42px; transition: transform 0.3s ease; }
.sm-scope .sm-logo-img { display: block; height: 100%; width: 100%; object-fit: contain; }
...
@media (max-width: 1399px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } }
